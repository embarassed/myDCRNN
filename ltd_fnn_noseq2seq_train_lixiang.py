...
from model.ltd_fnn_noseq2seq_supervisor import LTDFNNSupervisor
...
flags.DEFINE_integer('num_fnn_layers', 1, 'num_fnn_layers')
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        for name in ['batch_size', 'epochs', 'horizon', 'learning_rate', 'l1_decay',
                     ...
                     'patience', 'seq_len', 'verbose', 'num_fnn_layers']:
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = LTDFNNSupervisor(traffic_reading_df=traffic_reading_df, config=supervisor_config)

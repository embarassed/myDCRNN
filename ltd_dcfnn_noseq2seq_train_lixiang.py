...
from model.ltd_dcfnn_noseq2seq_supervisor import LTDDCFNNSupervisor
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = LTDDCFNNSupervisor(traffic_reading_df=traffic_reading_df, adj_mx=adj_mx, config=supervisor_config)

...
from model.ltd_psrnn_supervisor import LTDPSRNNSupervisor
...
flags.DEFINE_string('config_filename', 'data/model/psrnn_config_lixiang.yaml', 'Configuration filename for restoring the model.')
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        traffic_reading_df = traffic_reading_df.ix[:, 0]
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = LTDPSRNNSupervisor(traffic_reading_df=traffic_reading_df,

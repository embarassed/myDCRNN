...
flags.DEFINE_string('sensor_ids_filename', 'data/sensor_graph/graph_sensor_ids_lixiang.txt',
                    'File containing sensor ids separated by comma.') # 772669 not have
...
flags.DEFINE_string('output_pkl_filename', 'data/sensor_graph/adj_mat_lixiang.pkl', 'Path of the output file.')

...
from model.ltd_avdcrnn_supervisor import LTDDCRNNSupervisor
...
flags.DEFINE_string('config_filename', 'data/model/adcrnn_config_lixiang.yaml', 'Configuration filename for restoring the model.')
...
flags.DEFINE_integer('num_heads', -1, 'num of heads_attention')
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        for name in ['batch_size', 'cl_decay_steps', 'epochs', 'horizon', 'learning_rate', 'l1_decay',
                     ...
                     'patience', 'seq_len', 'verbose', 'max_diffusion_step', 'num_heads']:
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = LTDDCRNNSupervisor(traffic_reading_df=traffic_reading_df, adj_mx=adj_mx,

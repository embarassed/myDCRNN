...
from model.ltd_dcrnn_stack_flow_occ_speed_supervisor import LTDDCRNNSTACKFOSSupervisor
...
flags.DEFINE_string('config_filename', 'data/model/dcrnn_stack_config_lixiang.yaml', 'Configuration filename for restoring the model.')
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = LTDDCRNNSTACKFOSSupervisor(traffic_reading_df=traffic_reading_df_s[0] ,traffic_reading_df_addition=traffic_reading_df_s[1:], adj_mx=adj_mx,

...
from model.fnn_flow_occ_speed_supervisor import FNNFOSSupervisor
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = FNNFOSSupervisor(traffic_reading_df=traffic_reading_df_s[0] ,traffic_reading_df_addition=traffic_reading_df_s[1:], config=supervisor_config)

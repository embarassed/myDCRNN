...
from model.dcrnn_sandwich_supervisor import DCRNNSandwichSupervisor
...
flags.DEFINE_string('config_filename', 'data/model/dcrnn_sandwich_config_lixiang.yaml', 'Configuration filename for restoring the model.')
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = DCRNNSandwichSupervisor(traffic_reading_df=traffic_reading_df, adj_mx=adj_mx,

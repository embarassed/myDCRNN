...
from model.dayweekly_clips_cnn_v2dcrnn_model import CLIPSCNNDCRNNModel
from model.ltd_dayweekly_clip_2tf_model_supervisor import LTDTFModelSupervisor
...
class LTDDCRNNSupervisor(LTDTFModelSupervisor):
    ...
    def _generate_run_id(config):
        ...
        if filter_type == 'random_walk':
            ...
            filter_type_abbr = 'DR'
        run_id = 'ltd_day12week4ly_clip_%d_rseql24_cnn3_64D_v2dcrnn_%s_%d_h_%d_%s_lr_%g_bs_%d_d_%.2f_sl_%d_%s_%s/' % (

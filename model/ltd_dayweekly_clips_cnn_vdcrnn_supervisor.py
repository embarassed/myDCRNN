...
from model.dayweekly_clips_cnn_vdcrnn_model import CLIPSCNNDCRNNModel
...
class LTDDCRNNSupervisor(LTDTFModelSupervisor):
    ...
    def _generate_run_id(config):
        ...
        if filter_type == 'random_walk':
            ...
            filter_type_abbr = 'DR'
        run_id = 'ltd_day12week4ly_clip_%d_rseql24_cnn3_64D_vdcrnn_%s_%d_h_%d_%s_lr_%g_bs_%d_d_%.2f_sl_%d_%s_%s/' % (

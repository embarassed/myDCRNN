...
class TFModelFOSSupervisor(object):
    """
    ...
    def _prepare_scaler_train_val_test_addition_data(self, df_addition_data_s):
        ...
        for ind in range(addition_num):
            ...
            x_train, _ = utils.generate_graph_seq2seq_io_data_with_time(train_data,
                                                                  ...
                                                                  add_day_in_week=False)
            x_val, _ = utils.generate_graph_seq2seq_io_data_with_time(val_data, batch_size=batch_size,
                                                                    seq_len=seq_len,
                                                                    horizon=horizon,
                                                                    num_nodes=num_nodes,
                                                                    scaler=scaler,
                                                                    add_time_in_day=False,
                                                                    add_day_in_week=False)
            x_test, _ = utils.generate_graph_seq2seq_io_data_with_time(test_data,

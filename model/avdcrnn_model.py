...
class ADCRNNModel(TFModel):
    def __init__(self, is_training, config, scaler=None, adj_mx=None):
        super(ADCRNNModel, self).__init__(config, scaler=scaler)
        ...
        num_heads = int(config.get('num_heads'))
        ...
        with tf.variable_scope('DCRNN_SEQ'):
            ...
            def attention(query):
                ...
                return ds
            # rnn_decoder:
            dec_outputs, _ = self.attention_rnn_decoder_variant(labels, num_nodes, num_heads, enc_states, decoding_cells, loop_function, attention)
        outputs = dec_outputs

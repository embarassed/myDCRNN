...
class DCGORUCell(RNNCell):
    ...
    def __init__(self, num_units, adj_mx, max_diffusion_step, num_nodes, capacity=8, fft=False,
                 num_proj=None, activation=modrelu, reuse=None, filter_type="laplacian", scope=None):
        ...
        super(DCGORUCell, self).__init__(_reuse=reuse)

...
class LTDFNNSupervisor(LTDTFModelSupervisor):
    """
    Do experiments using Graph Random Walk RNN model.
    """

    def __init__(self, traffic_reading_df, config):
        super(LTDFNNSupervisor, self).__init__(config, df_data=traffic_reading_df)
    ...
    def _generate_run_id(config):
        ...
        run_id = 'ltd_fnn_noseq2seq_h_%d_%s_lr_%g_bs_%d_d_%.2f_sl_%d_%s_%s/' % (
            horizon,

...
from model.dcrnn_newgraph_supervisor import DCRNNSupervisor
...
flags.DEFINE_string('config_filename', 'data/model/dcrnn_newgraph_config_lixiang.yaml', 'Configuration filename for restoring the model.')

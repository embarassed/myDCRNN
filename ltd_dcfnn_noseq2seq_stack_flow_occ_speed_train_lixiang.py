...
from model.ltd_dcfnn_noseq2seq_stack_flow_occ_speed_supervisor import LTDDCFNNSTACKFOSSupervisor
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = LTDDCFNNSTACKFOSSupervisor(traffic_reading_df=traffic_reading_df_s[0] ,traffic_reading_df_addition=traffic_reading_df_s[1:], adj_mx=adj_mx, config=supervisor_config)

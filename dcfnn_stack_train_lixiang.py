...
from model.dcfnn_stack_supervisor import DCFNNSTACKSupervisor
...
def main():
    ...
    with open(FLAGS.config_filename) as f:
        ...
        with tf.Session(config=tf_config) as sess:
            supervisor = DCFNNSTACKSupervisor(traffic_reading_df=traffic_reading_df, adj_mx=adj_mx, config=supervisor_config)
